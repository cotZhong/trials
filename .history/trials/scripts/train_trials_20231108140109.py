...
def train(args, run_id):
    ...
    print(args.rolling_serial, len(train))
...
def main(
    ...
    rolling_dataset_path: str = r"D:\option+and+optimization\option and optimization\Transquant\HRL_Select_and_Trade\trials\trials\data\CIS\\",
    policy: str = "simple_serial_selection",
    feature_extractor: str = "mlp",
    trading_feature_extractor: str = "lstm",
    asset_attention: bool = False,
    rolling_serial: int = 2,
    asset_num: int = 30,
    feature_dim: int = 3,
